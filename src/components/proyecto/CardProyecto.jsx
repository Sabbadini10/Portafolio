...
function CardProyecto(props) {
  ...
  <p className="cardProyectos-parrafo title text-start text-light">Deploy: <a href={props.deploy} class="text-light mt-1">Link Deploy</a></p>
  <br/>
  <p className="cardProyectos-parrafo title text-start text-light">Git-Hub: <a href={props.github} class="text-light mt-1">Link Git-Hub</a></p>
  </div>
  </div>
</>
  )
